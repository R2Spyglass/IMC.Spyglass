...
{
    print("==========================================")
    print("[Spyglass] Loading autogenerated database.")
    print("==========================================")
    ...
    PlayerInfraction infraction_1005829030626_0 = { PlayerUsername = "ErliteDev", Type = InfractionType.Cheating, Date = "17-SEPT-22", Issuer = "Erlite#1337", Reason = "Gamer words."};
